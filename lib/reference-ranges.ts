...
export const hematologyReferenceRanges: ReferenceRangeGroup = {
  ...
  ranges: [
    ...
    { analyte: "WBC count", range: "4.5-11.0", unit: "x10⁹/L" },
    { analyte: "RBC count (male)", range: "4.5-5.9", unit: "10¹²/L" },
    { analyte: "RBC count (female)", range: "4.0-5.2", unit: "10¹²/L" },
    { analyte: "Platelet count", range: "150-400", unit: "x10⁹/L" },
    ...
    { analyte: "Absolute neutrophil count", range: "1.5-8.0", unit: "10⁹/L" },
  ],
}
...
export const chemistryReferenceRanges: ReferenceRangeGroup = {
  ...
  ranges: [
    ...
    { analyte: "Urea", range: "10-50", unit: "mg/dL" },
    { analyte: "Creatinine", range: "0.2-1.4", unit: "mg/dL" },
    ...
    { analyte: "Bicarbonate (CO₂)", range: "22-32", unit: "mmol/L" },
    ...
    { analyte: "HDL cholesterol", range: "40-80", unit: "mg/dL" },
    { analyte: "Triglycerides", range: "60-180", unit: "mg/dL" },
